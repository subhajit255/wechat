        ...
        <div class="col-md-12">
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="members">
                    ...
                    <div class="list-group sort">
                        <button class="btn filterMembersBtn active show" data-toggle="list"
                            data-filter="all" id="all_user">All</button>
                        <button class="btn filterMembersBtn" id="online_user" data-toggle="list" data-filter="online">Online</button>
                        <button class="btn filterMembersBtn" id="offline_user" data-toggle="list" data-filter="offline">Offline</button>
                    </div>
                    <div class="contacts">
                        <h1>Contacts</h1>
                ...
                <div id="discussions" class="tab-pane fade active show">
                    ...
                    <div class="discussions">
                        ...
                        <div class="list-group" id="chats" role="tablist">
                            ...
                            <a href="#list-empty" class="filterDiscussions all unread single" id="list-empty-list"
                                data-toggle="list" role="tab">
                                <img class="avatar-md" src="dist/img/avatars/avatar-male-1.jpg" data-toggle="tooltip"
                            ...
                            <a href="#list-empty" class="filterDiscussions all read single" id="list-empty-list2"
                                data-toggle="list" role="tab">
                                <img class="avatar-md" src="dist/img/avatars/avatar-male-2.jpg" data-toggle="tooltip"
                                    data-placement="top" title="Mariette" alt="avatar">
                                <div class="status">
                                    <i class="material-icons offline">fiber_manual_record</i>
                                </div>
                                <div class="data">
                            ...
                            <a href="#list-empty" class="filterDiscussions all read single" id="list-empty-list4"
                                data-toggle="list" role="tab">
                                <img class="avatar-md" src="dist/img/avatars/avatar-male-3.jpg" data-toggle="tooltip"
                                    data-placement="top" title="Ryan" alt="avatar">
                                <div class="status">
                                    <i class="material-icons offline">fiber_manual_record</i>
                                </div>
                                <div class="data">
                            ...
                            <a href="#list-chat" class="filterDiscussions all unread single" id="list-chat-list5"
                                data-toggle="list" role="tab">
                                <img class="avatar-md" src="dist/img/avatars/avatar-male-4.jpg" data-toggle="tooltip"
                                    data-placement="top" title="Mildred" alt="avatar">
                                <div class="status">
                                    <i class="material-icons offline">fiber_manual_record</i>
                                </div>
                ...
                <div class="tab-pane fade" id="settings">
                    <div class="settings">
                        <div class="profile">
                            <img class="avatar-xl" src="" alt="avatar">
                            <h1><a href="#" class="user-name"></a></h1>
                        ...
                        <div class="categories" id="accordionSettings">
                            ...
                            <div class="category">
                                ...
                                <div class="collapse" id="collapseOne" aria-labelledby="headingOne"
                                    ...
                                    <div class="content">
                                        <form class="formSubmit fileUpload" id="update_profile" action="{{route('update-profile')}}">
                                            <input type="hidden" name="id" id="id">
                                            <div class="upload">
                                                <div class="data">
                                                    <img class="avatar-xl" src="" alt="image">
                                                    <label>
                                            ...
                                            <div class="field">
                                                ...
                                                <input type="text" class="form-control" id="name"
                                                    placeholder="name" value="" name="name" required>
                                            </div>
                                            <div class="field">
                                            ...
                                            <button type="submit" class="btn button w-100 submit-form">Apply</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="history">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="save-info">Delete
                                                    will remove your chat history from the device.</label>
                                            </div>
                            ...
                            <div class="category">
                                ...
                                <div class="collapse" id="collapseFour" aria-labelledby="headingFour"
                                    ...
                                    <div class="content">
                                        <div class="app">
                                            <img src="{{asset('assets/dist/img/integrations/slack.svg')}}" alt="app">
                                        ...
                                        <div class="app">
                                            <img src="{{asset('assets/dist/img/integrations/dropbox.svg')}}" alt="app">
                                            <div class="permissions">
                                                <h5>Dropbox</h5>
                                        ...
                                        <div class="app">
                                            <img src="{{asset('assets/dist/img/integrations/drive.svg')}}" alt="app">
                                            <div class="permissions">
                                                <h5>Google Drive</h5>
                                        ...
                                        <div class="app">
                                            <img src="{{asset('assets/dist/img/integrations/trello.svg')}}" alt="app">
                                            <div class="permissions">
                                                <h5>Trello</h5>
                                                <p>No permissions set</p>
                                            </div>
                                        ...
                                        <div class="set">
                                            <div class="details">
                                                ...
                                                <p>If enabled anyone in or out your friends of friends list
                                                    can send you a friend request.</p>
                                            </div>
                                            <label class="switch">
                                                <input type="checkbox" checked>
                                                <span class="slider round"></span>
